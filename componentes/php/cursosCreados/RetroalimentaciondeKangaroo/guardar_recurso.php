...
";
        ...
        echo "🧾 Título original: '$tituloOriginal'";
        echo "📁 Título normalizado: '$tituloRecurso'";
        echo "📁 Sección normalizada: '$nombreSeccion'";
        ...
        if ($stmtInsert->execute()) {
            echo "✅ Lección '$tituloRecurso' insertada en sección '$nombreSeccion' con ID $nuevoId";
        } else {
        ...
        if ($esLibro === "true"){
            ...
            $info = "Título: $tituloOriginal Descripción: $descripcion URL: $url";
            file_put_contents("$rutaRecurso/info.txt", $info);
